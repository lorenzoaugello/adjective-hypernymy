...
for idx, row in df.iterrows():
    ...
    prompt = f"""Given the hyponym adjective "{hyponym}" with definition "{definition}", generate its related adjective hypernym, respecting the following guidelines:
...
- Always output an adjective. The hypernym must be an adjective. The relation must hold between two lemmas that have the same part of speech. You cannot output a different part of speech than adjective.
