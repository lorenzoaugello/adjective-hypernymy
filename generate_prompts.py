...
for idx, row in df.iterrows():
    ...
    prompt = f"""Given the hyponym adjective "{hyponym}" with definition "{definition}", generate a list of related adjective hypernyms. Only a list of adjective hypernyms must be in the output, nothing else more. Respect the following guidelines:
